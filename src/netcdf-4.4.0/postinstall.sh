...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lm " CFLAGS="-I/home/rama/git/hub/calpuff/calwrf/lib/netcdf/include" LDFLAGS="-L/home/rama/git/hub/calpuff/calwrf/lib/netcdf/lib" ./configure --prefix=/home/rama/git/hub/calpuff/calwrf/lib/netcdf $STATIC_BUILD $SHARED_BUILD
        LIBS="-lm " make
        LIBS="-lm " make check
    fi
