...
c
c --- UPDATE
c --- v2.55 - v2.56 080407 (EPA)   : Exponential notation processing in ALTONU 
...
c----------------------------------------------------------------------
c
      character(len=*) cfile   !MODIFICADO POR RAMIRO
      character*1 cchar,clc(29),cuc(29)
      logical lcfiles
      integer :: letrasdecfile !MODIFICADO POR RAMIRO
c
...
c
      if(lcfiles)then
      letrasdecfile=len(cfile)  !MODIFICADO POR RAMIRO
c
c ---    Convert file name to lower case letters
         do i=1,letrasdecfile
            cchar=cfile(i:i)
c
            do j=1,29
...
c
c --- UPDATES
c --- V2.56 (080407) from V1.0 (000602) (EPA)
...
c --- Note: Comment out this call to etime if using GNU gfortran
c     call etime(rcpu)
