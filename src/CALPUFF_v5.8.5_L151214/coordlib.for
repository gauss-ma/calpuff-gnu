...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version 5.8.4     Level: 130731
C                EPA
C
c --- COORDLIB   Version: 1.98     Level: 060911
c 
c     Copyright (c) 2003-2006 by Exponent, Inc.
c
c -----------------------------
c --- CONTENT:
c -----------------------------
...
C --- v1.98-v5.8.4  130731  (EPA): EPA released version
C
c                                : A non-zero False Northing appropriate 
c                                  for UTM-S was used when converting 
c                                  S. hemisphere locations to UTM-N 
c                                  coordinates.  This causes the 
c                                  coordinates returned to be in UTM-S.
c
c                                : Three work-array variables and one 
c                                  output variable were not completely 
c                                  initialized, causing the program to 
c                                  halt when extra compiler-checking 
c                                  options are used.
c
...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.98     Level: 060626                 GLOBE1
c                D. Strimaitis
c
...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.98     Level: 050126                  GLOBE
...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.98     Level: 030905               NIMADATE
c                D. Strimaitis   EarthTech
c
...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.98     Level: 050126             COORDSVER
c                D. Strimaitis   EarthTech
c
...
C----------------------------------------------------------------------
C
C --- COORDLIB   Version: 1.98     Level: 060911                 COORDS
C
...
c --- Set the COORDS version and level string
      ...
      verdoc=' ---  COORDLIB   Version: 1.98   Level: 060911 '
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.98     Level: 021024                 PRJCHK
c
c --- Program was written by Gary Moore
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.98     Level: 020623                 ERRPRT
c
c --- Program was written by Gary Moore
c                            Earth Tech @2002  all rights
c                            Atmospheric Studies Group (ASG)
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.98     Level: 020710                 LL2ZON
c
c --- Program was written by Gary Moore
c                            Earth Tech @2002  all rights
c                            Atmospheric Studies Group (ASG)
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.98     Level: 020624                 DD2DMS
c
c
c --- Program was written by Gary Moore
c                            Earth Tech @2002  all rights
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.98     Level: 030905                DAT2DAT
c
c --- Program was written by Gary Moore
c                            Earth Tech @2002  all rights
c                            Atmospheric Studies Group (ASG)
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.98     Level: 030905                DATSHFT
c
...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.98     Level: 021016                   INIT
c
c --- Program was written by Gary Moore at Earth Tech - Concord MA
c
