...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.95     Level: 050126
c
c                  Earth Tech, Inc.
c                  196 Baker Avenue
c                  Concord, MA  01742
c                  (978) 371-4200
c 
c     Copyright (c) 2003-2005 by Exponent, Inc.
c
c --- UPDATE
c
...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.95     Level: 050126                  GLOBE
...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.95     Level: 030905               NIMADATE
c                D. Strimaitis   EarthTech
c
...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.95     Level: 050126             COORDSVER
c                D. Strimaitis   EarthTech
c
...
C----------------------------------------------------------------------
C
C --- COORDLIB   Version: 1.95     Level: 050126                 COORDS
C
C --- Program was written by Gary Moore
C                            Earth Tech @2002,2003,2004  all rights
...
c      DATA IPR,JPR /0,0/
     ...
     *        'LL2PS      ','LL2EM      ','LL2TM      ','UTM2LL     ',
     *        'UTM2UTM    ','UTM2LCC    ','UTM2LAZA   ','UTM2PS     ',
     *        'UTM2EM     ','UTM2TM     ','LCC2LL     ','LCC2UTM    ',
     *        'LCC2LCC    ','LCC2LAZA   ','LCC2PS     ','LCC2EM     ',
     *        'LCC2TM     ','LAZA2LL    ','LAZA2UTM   ','LAZA2LCC   ',
     *        'LAZA2LAZA  ','LAZA2PS    ','LAZA2EM    ','LAZA2TM    ',
     *        'PS2LL      ','PS2UTM     ','PS2LCC     ','PS2LAZA    ',
     *        'PS2PS      ','PS2EM      ','PS2TM      ','EM2LL      ',
     *        'EM2UTM     ','EM2LCC     ','EM2LAZA    ','EM2PS      ',
     *        'EM2EM      ','EM2TM      ','TM2LL      ','TM2UTM     ',
     *        'TM2LCC     ','TM2LAZA    ','TM2PS      ','TM2EM      ',
     *        'TM2TM      '/
      DATA SYSFLG/0,0,0,1,0,4,0,11,0,6,0,5,0,9,
     *            1,0,1,1,1,4,1,11,1,6,1,5,1,9,
     *            4,0,4,1,4,4,4,11,4,6,4,5,4,9,
     *            11,0,11,1,11,4,11,11,11,6,11,5,11,9,
     *            6,0,6,1,6,4,6,11,6,6,6,5,6,9,
     *            5,0,5,1,5,4,5,11,5,6,5,5,5,9,
     *            9,0,9,1,9,4,9,11,9,6,9,5,9,9/
      DATA TDUM /15*1.0D0/
C
      FN27(1:7) = IPATH1
      FN83(1:7) = IPATH2
...
c --- Set the COORDS version and level string
      ...
      verdoc=' ---  COORDLIB   Version: 1.95   Level: 050126 '
...
C --- UTM,LCC,LAZA,PS,MC = METERS OR KILOMETERS
      XMULTI = 1.0
      IF(INSYS.EQ.0)THEN
         INUNIT = 4
      ELSE
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.95     Level: 021024                 PRJCHK
c
c --- Program was written by Gary Moore
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.95     Level: 020623                 ERRPRT
c
c --- Program was written by Gary Moore
c                            Earth Tech @2002  all rights
c                            Atmospheric Studies Group (ASG)
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.95     Level: 020710                 LL2ZON
c
c --- Program was written by Gary Moore
c                            Earth Tech @2002  all rights
c                            Atmospheric Studies Group (ASG)
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.95     Level: 020624                 DD2DMS
c
c
c --- Program was written by Gary Moore
c                            Earth Tech @2002  all rights
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.95     Level: 030905                DAT2DAT
c
c --- Program was written by Gary Moore
c                            Earth Tech @2002  all rights
c                            Atmospheric Studies Group (ASG)
...
c----------------------------------------------------------------------
c
C --- COORDLIB   Version: 1.95     Level: 030905                DATSHFT
c
...
c----------------------------------------------------------------------
c
c --- COORDLIB   Version: 1.95     Level: 021016                   INIT
c
c --- Program was written by Gary Moore at Earth Tech - Concord MA
c
